  ...
  const values = [
    {
      ...
      description: 'Nous sélectionnons rigoureusement nos répétiteurs pour garantir un enseignement de qualité.'
    },
    {
      icon: <FaUsers className="text-3xl mb-4 text-blue-600" />,
      title: 'Approche personnalisée',
      description: 'Des solutions adaptées à chaque étudiant pour maximiser leur potentiel.'
    },
    {
      icon: <FaLightbulb className="text-3xl mb-4 text-blue-600" />,
      title: 'Innovation pédagogique',
      description: 'Méthodes modernes et outils interactifs pour un apprentissage efficace.'
    },
    {
    ...
    <div className="font-sans bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Notre histoire a commencé il y a quelques années, lorsqu'un groupe de passionnés d'éducation a remarqué une lacune dans l'offre de cours particuliers accessibles et de qualité.
              </p>
              <p className="text-lg text-gray-600 mb-6">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Prêt à commencer votre parcours ?</h2>
